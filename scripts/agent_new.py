...
CONFIG = {'scan_subnet': '10.10.0.0/16', 'passive_discovery': True, 'sniff_interface': 'eth1', 'asset_discovery': True, 'traffic_capture': True, 'host_monitoring': True, 'host_info': {'hostname': 'agent-host', 'platform': 'Linux', 'platform_release': '6.8.0-1030-azure', 'platform_version': '#35~22.04.1-Ubuntu SMP Mon May 26 18:08:30 UTC 2025', 'architecture': 'x86_64', 'processor': 'x86_64', 'cpu_percent': 3.3, 'memory_percent': 26.2, 'disk_percent': 90.3, 'boot_time': '2026-01-06T09:02:18', 'interfaces': [{'name': 'lo', 'ip': '127.0.0.1', 'status': 'up'}, {'name': 'eth0', 'ip': '172.28.0.150', 'status': 'up'}, {'name': 'eth1', 'ip': '10.10.1.10', 'status': 'up'}]}, 'last_host_update': '2026-01-06T09:08:45.188397'}
