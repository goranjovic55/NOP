...
> Core workflow in akis agent. This file: END details + verification + log format.
...
**G5 violation costs +8.5 min rework** per error. Verify immediately after edit.
...
**G4 compliance = 78.2%**. Improve to 95%+ by creating workflow log when:
- Session >15 minutes
